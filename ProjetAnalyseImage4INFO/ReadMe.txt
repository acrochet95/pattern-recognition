========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet ProjetAnalyseImage4INFO
========================================================================

AppWizard a créé cette application ProjetAnalyseImage4INFO pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application ProjetAnalyseImage4INFO.


ProjetAnalyseImage4INFO.vcxproj
...
ProjetAnalyseImage4INFO.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) ProjetAnalyseImage4INFO.pch et un fichier de type précompilé nommé StdAfx.obj.
